  ...
  return (
    <div className="min-h-svh bg-blue-50/30 text-black dark:bg-gradient-to-b dark:from-[#0b1220] dark:to-[#0f1c35] dark:text-white">
      ...
      <main className="mx-auto max-w-4xl px-4 md:px-6 py-10 space-y-6">
        <header>
          <h1 className="text-3xl font-extrabold tracking-tight text-blue-600 dark:text-blue-400">{isEN ? "Frequently Asked Questions" : "Pertanyaan yang Sering Diajukan"}</h1>
        ...
        <section className="space-y-4">
          <details className="rounded-lg border-2 border-blue-100 bg-white p-4 shadow-md open:shadow-lg dark:border-white/10 dark:bg-[#0d172b] dark:open:shadow-md dark:open:shadow-blue-500/10">
