    ...
    <ProtectedRoute allowedRoles={['team']}>
      <div className="min-h-svh bg-gradient-to-b from-[#0b1220] to-[#0f1c35] text-white">
        ...
        <section className="rounded-xl border border-white/10 bg-[#0d172b] p-6 shadow-xl shadow-blue-500/10">
          <h2 className="text-3xl font-bold text-blue-400 mb-4">Panduan Kerja Sertifikat</h2>
          <ol className="space-y-3 text-white/80 list-decimal pl-5">
            <li>Cari atau buat data sertifikat dari panel kanan.</li>
            <li>Edit detail di halaman edit sertifikat.</li>
            <li>Generate dan review sebelum publikasi.</li>
          </ol>
        </section>
