    ...
    <ProtectedRoute allowedRoles={['team']}>
      <div className="min-h-svh bg-gradient-to-b from-[#0b1220] to-[#0f1c35] text-white">
        ...
        <aside className="rounded-xl border border-white/10 bg-[#0d172b] p-5 space-y-4">
          ...
          <button className="w-full rounded-md bg-blue-600 hover:bg-blue-500 px-4 py-2 text-sm font-medium">Generate</button>
          <div>
            <label className="block text-sm text-white/70 mb-2">Enter QR Code Data</label>
            <input className="w-full rounded-md border border-white/10 bg-white/5 px-3 py-2 text-sm" placeholder="" />
          </div>
          <button className="w-full rounded-md border border-white/10 bg-white/5 hover:bg-white/10 px-4 py-2 text-sm">Generate QR Code</button>
          <div>
